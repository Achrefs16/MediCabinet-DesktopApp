...
const Accueil = () => {
const cards = [
  { id: 1, name: "Nouveau patient", icon: <HiUserAdd className="text-sky-600 text-3xl" /> },
  { id: 2, name: "Patients", icon: <BsPersonStanding className="text-red-600 text-3xl" /> },
  { id: 3, name: "Ordonnance", icon: <BsFileText className="text-violet-600 text-2xl" /> },
  { id: 4, name: "Consultation", icon: <HiOutlineClipboardList className="text-green-600 text-3xl" /> },
  { id: 5, name: "Compte-rendu", icon: <HiUserAdd className="text-green-600 text-3xl" /> },
  { id: 6, name: "Courrier", icon: <HiUserAdd className="text-green-600 text-3xl" /> },
  { id: 7, name: "Examen Lab.", icon: <HiUserAdd className="text-green-600 text-3xl" /> },
  { id: 8, name: "Demande radio", icon: <HiUserAdd className="text-green-600 text-3xl" /> }
];
    ...
    <div className=" h-full w-full  text-center flex">
      ...
      <h1 className="text-6xl my-6 font-bold text-green-700">Cabinet Achref</h1>
        <div className="flex items-center w-fit mx-auto  text-left">
            ...
            <button className={`${isopen&& 'rotate-180'} transition bg-gray-300 py-1.5  px-1 text-gray-700`} onClick={()=>Setopen((prv)=>!prv) }><IoIosArrowDown/></button>
